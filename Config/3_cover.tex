...
\nttitle(main,en){Advanced Automation for MEC environments}%
...
\ntdegreename*(en){Telecommunications MAP-tele from the Universities of Minho, Aveiro and Porto}
...
%-------------------------------------------------------------------
\ntauthorname(m){Paulo Jorge Nicolau Araújo}{Paulo Araújo}
...
%-------------------------------------------------------------------
% Advisers(s)
\ntaddperson{adviser}(a,m){Alexandre Júlio Teixeira Santos, Full Professor, University of Minho}
% Co-advisers(s)
\ntaddperson{adviser}(c,f){Helena Fernández Lopéz, Invited Professor, Gradiant}
