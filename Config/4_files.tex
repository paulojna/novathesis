...
\ntaddfile{chapter}{1-introduction/INTRODUCTION}
\ntaddfile{chapter}{2-ml-for-VEC-orchestration/ML_FOR_VEC}
\ntaddfile{chapter}{3-integrated-system-architecture/INTEGRATED_SYSTEM_ARCHITECTURE}
\ntaddfile{chapter}{4-framework/FRAMEWORK}
\ntaddfile{chapter}{5-tests-and-analysis/TESTS_AND_ANALYSIS}
\ntaddfile{chapter}{6-conclusions/CONCLUSIONS}
